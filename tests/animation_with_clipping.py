...
# Create Polygon 02
p2 = poly.create()
p2 = poly.insert_dot(p2, [0.75, -0.25, 0, 0])
p2 = poly.insert_dot(p2, [1.25, -0.25, 1, 0])
p2 = poly.insert_dot(p2, [1.25, 0.25, 1, 1])
p2 = poly.insert_dot(p2, [0.75, 0.25, 0, 1])

# Create transformation matrix: Rotation
m_t = transform.create()
m_t = transform.translation(m_t, -1, 0)
